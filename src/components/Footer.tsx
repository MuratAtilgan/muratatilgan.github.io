  ...
  return (
    <footer className="border-t border-zinc-800 py-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-zinc-500">
      ...
      <div className="flex gap-6">
        <a href="mailto:muratatilgan@hotmail.co.uk" className="hover:text-zinc-200 transition-colors">Email</a>
        <a href="https://www.linkedin.com/in/murat-atilgan-251115179/" target="_blank" rel="noopener noreferrer" className="hover:text-zinc-200 transition-colors">LinkedIn</a>
